...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldgate East", "Angle", "Baker Street", "Bank", "Barbican", "Bayswater", "Blackfriars", "Bond Street", "Borough", "Cannon Street", "Chancery Lane", "Charing Cross", "Covent Garden", "Earl's Court", "Edgeware Road", "Elephant & Castle", "Embankment", "Euston", "Euston Square", "Farringdon", "Gloucester Road", "Goodge Street", "Great Portland Street", "Green Park", "High Street Kensington", "Holborn", "Hyde Park Corner", "King's Cross", "Knightsbridge", "Lambeth North", "Lancaster Gate", "Leicester Sqaure", "Liverpool Street", "London Bridge", "Mansion House", "Marble Arch", "Marylebone", "Monument", "Moorgate", "Notting Hill Gate", "Old Street", "Oxford Circus", "Pimlico", "Queensway", "Regent's Park", "Russell Square", "Sloan Square", "South Kensington", "St Pancras", "St. Paul's", "Temple", "Tottenham Court Road", "Tower Gateway", "Tower Hill", "Vauxhall", "Victoria", "Warren Street", "Waterloo East", "Waterloo", "Westminster"};
        ...
        londonUGLines[0][0] = "Bakerloo Line";
        londonUGLines[0][1] = "Baker Street";
        ...
        londonUGLines[0][9] = "Regenet's Park";
        ...
        londonUGLines[2][14] = "Kings Cross";
        ...
        londonUGLines[2][20] = "Sloane Kensington";
        ...
        londonUGLines[4][1] = "Aldgare East";
        ...
        londonUGLines[6][2] = "Liverpoot Street";
        ...
        londonUGLines[7][0] = "Northen Line";
